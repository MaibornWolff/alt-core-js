...
class RestAction implements Action {
    ...
    invoke(scenario: Scenario): ActionCallback {
        ...
        let updateScenarioCache = function (res: any) {     // `res` needed for the `eval()` call
                ...
                .then(response => {
                    ...
                    if (response.statusCode === 200 || response.statusCode === 201) {
                        ...
                        if(contentType != null) {
                            ...
                            addSuccessfulResponse(scenario.name, targetService, `${response.statusMessage} (${response.statusCode})`, res);
