...
var _OUT_DIR = '';
exports.runScenario = function (scenarioPath, actionDir, outDir, envConfigFile) {
    if (outDir === void 0) { outDir = 'out'; }
    try {
        ...
        logging_1.getLogger("unknown").info("Starting scenario: " + scenarioPath + " (actions: " + actionDir + ", out: " + outDir + ", envConfig: " + envConfigFile + ")");
        _OUT_DIR = outDir;
...
exports.OUTPUT_DIR = function () { return _OUT_DIR; };
