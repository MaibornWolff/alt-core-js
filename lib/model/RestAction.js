    ...
    RestAction.prototype.invoke = function (scenario) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            var requestBody = _this.data ?
                util_1.isArray(_this.data) ? JSON.stringify(_this.data) : JSON.stringify(variableInjection_1.injectVarsToMap(variableInjection_1.injectEvaluationToMap(_this.data, ctx), scenario.cache, ctx))
                :
                    null;
