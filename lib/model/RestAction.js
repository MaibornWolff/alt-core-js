...
var RestAction = /** @class */ (function () {
    function RestAction(name, actionDef, url, serviceName, restMethod, restHeaders, restData, restDataBinary, restForm, validators, vars) {
        ...
        if (restDataBinary === void 0) { restDataBinary = actionDef.dataBinary; }
    ...
    RestAction.prototype.invoke = function (scenario) {
        ...
        var promise = new Promise(function (resolve, reject) {
            var requestHeaders = _this.restHead ? variableInjection_1.injectEvalAndVarsToMap(_this.restHead, scenario.cache, ctx) : null;
            var requestBody = _this.data ?
                Array.isArray(_this.data) ? JSON.stringify(_this.data) : JSON.stringify(variableInjection_1.injectEvalAndVarsToMap(_this.data, scenario.cache, ctx))
                :
                    null;
            var requestForm = _this.form ? variableInjection_1.injectEvalAndVarsToMap(_this.form, scenario.cache, ctx) : null;
            var binaryData = _this.dataBinary ? FS.createReadStream(_this.dataBinary) : null;
            request({
                method: _this.method,
                url: variableInjection_1.injectEvalAndVarsToString(_this.url, scenario.cache, ctx),
