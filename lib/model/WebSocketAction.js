...
var WebSocketAction = /** @class */ (function () {
    ...
    WebSocketAction.prototype.invokeAsync = function (scenario) {
        ...
        var resolvedUrl = variableInjection_1.injectEvalAndVarsToString(this.url, scenario.cache, ctx);
        var queryParams = variableInjection_1.injectEvalAndVarsToMap(this.headers, scenario.cache, ctx);
        ...
        var isMessageRelevant = function (msg) {
            if (registeredMessageFilters) {
                return registeredMessageFilters.some(function (filter) {
                    filter = variableInjection_1.injectEvalAndVarsToString(filter, scenario.cache, ctx).toString();
