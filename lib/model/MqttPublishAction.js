...
var MqttPublishAction = /** @class */ (function () {
    ...
    MqttPublishAction.prototype.encodeProtoPayload = function () {
        return protoParsing_1.encodeProto(this.protoFile, this.data, this.protoClass).toString('utf-8');
    };
    MqttPublishAction.prototype.invokeAsync = function (scenario) {
        ...
        client.on('connect', function () {
            ...
            var payload = _this.protoFile ? _this.encodeProtoPayload() : JSON.stringify(variableInjection_1.injectEvaluationToMap(_this.data, ctx));
