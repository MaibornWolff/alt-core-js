...
var MqttPublishAction = /** @class */ (function () {
    ...
    MqttPublishAction.prototype.invokeAsync = function (scenario) {
        ...
        client.on('connect', function () {
            ...
            var payload = _this.protoFile ? _this.encodeProtoPayload(scenario.cache, ctx) : JSON.stringify(variableInjection_1.injectEvaluationToMap(_this.data, ctx, scenario.cache));
