...
exports.injectEvaluationToString = function (str, ctx) {
    var regex = /{{{([\w().+-\\*]*)}}}/g;
    searchForMatchingStrings(regex, str).forEach(function (expression) {
        var replaceValue = eval(expression);
        if (replaceValue) {
...
exports.injectEvaluationToNumber = function (str, ctx) {
    var regex = /<<<([\w().+-\\*]*)>>>/g;
    searchForMatchingStrings(regex, str).forEach(function (expression) {
        var replaceValue = eval(expression);
        if (replaceValue) {
...
exports.injectEvaluationToMap = function (keyValueMap, loggingCtx) {
    // let copy: any = {};
    // Object.assign(copy, keyValueMap);
    ...
    var replaced = exports.injectEvaluationToString(asString, loggingCtx);
    replaced = exports.injectEvaluationToNumber(replaced, loggingCtx);
